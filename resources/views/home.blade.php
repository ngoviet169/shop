...
<head>
    ...
    <title>Dầu nhớt xe ga | xe số | xe côn tay | xe PKL</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-2">
                    <div class="logo"><a href="{{route('home')}}"><img id="logo" src="https://lh4.googleusercontent.com/aSrlzFoB3_HcSsNwoGdvCTdE2k8vg5xJlRYK_LVPNFIT_P-TANdKQ-3op3qDGZsiTv7yfxOtfPzGGg=w1920-h949" alt="FlatShop"></a></div>
                </div>
